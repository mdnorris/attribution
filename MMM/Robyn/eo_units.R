...
df <- read.csv('eo_product.csv', fileEncoding = 'UTF-8-BOM')
...
InputCollect <- robyn_inputs(
  ...
  paid_media_spends = c("display", "brands_branded", "brands_category",
                        "products_auto", "products_branded", "products_category", "products_competitive"), # mandatory input
  paid_media_vars = c("display", "brands_branded", "brands_category",
                      "products_auto", "products_branded", "products_category", "products_competitive"), # mandatory.
...
hyperparameters <-list(
  display_alphas = c(.1, 9.9)
  , display_gammas = c(.1, 1)
  , display_shapes = c(0, 19.9)
  , display_scales = c(0, 1)
  
  , brands_branded_alphas = c(.1, 9.9)
  , brands_branded_gammas = c(.1, 1)
  , brands_branded_shapes = c(0, 19.9)
  , brands_branded_scales = c(0, 1)
  
  , brands_category_alphas = c(.1, 9.9)
  , brands_category_gammas = c(.1, 1)
  , brands_category_shapes = c(0, 19.9)
  , brands_category_scales = c(0, 1)
  
  , products_auto_alphas = c(.1, 9.9)
  , products_auto_gammas = c(.1, 1)
  , products_auto_shapes = c(0, 19.9)
  , products_auto_scales = c(0, 1)
  
  , products_branded_alphas = c(.1, 9.9)
  , products_branded_gammas = c(.1, 1)
  , products_branded_shapes = c(0, 19.9)
  , products_branded_scales = c(0, 1)
  
  , products_category_alphas = c(.1, 9.9)
  , products_category_gammas = c(.1, 1)
  , products_category_shapes = c(0, 19.9)
  , products_category_scales = c(0, 1)
  
  , products_competitive_alphas = c(.1, 9.9)
  , products_competitive_gammas = c(.1, 1)
  , products_competitive_shapes = c(0, 19.9)
  , products_competitive_scales = c(0, 1)
...
print(OutputCollect)
select_model <- "4_544_2" # Pick one of the models from OutputCollect to proceed
...
AllocatorCollect1 <- robyn_allocator(
  ...
  channel_constr_up = c(1.2, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5),
...
AllocatorCollect2 <- robyn_allocator(
  ...
  channel_constr_low = c(0.8, 0.7, 0.7, 0.7, 0.7, .8, .7),
  channel_constr_up = c(1.2, 1.5, 1.5, 1.5, 1.5, 1.5, 1.5),
...
json_file = "~/Desktop/Robyn_202305290110_init/RobynModel-4_544_2.json"
...
select_media <- "products_category"
...
## Input data from date 2023-02-26 or later required
...
json_file_rf1 <- "~/Desktop/Robyn_202305282014_init/Robyn_202305282034_rf1/RobynModel-1_97_3.json"
RobynRefresh <- robyn_refresh(
